<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAppShortcuts.ascx.cs" Inherits="WebForms.ucAppShortcuts" %>
<div>

    <a href="#" class="header-icon" data-toggle="dropdown" title="Aplicaciones">
        <i class="fal fa-cube"></i>
    </a>
    <div class="dropdown-menu dropdown-menu-animated w-auto h-auto">
        <div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center rounded-top">
            <h4 class="m-0 text-center color-white">Accesos directos
                <small class="mb-0 opacity-80">Aplicaciones & Plugins</small>
            </h4>
        </div>
            ...
            <ul class="app-list">
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Servicios
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Cuenta
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Seguridad
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Calendario
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Estadísticas
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Mensajes
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Notas
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Fotos
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Mapas
                        </span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Teléfono
                        </span>
                    </a>
                </li>
                <li>
                    <a href="#" class="app-list-item hover-white">
                        ...
                        <span class="app-list-name">Proyectos
                        </span>
                    </a>
                </li>
                <li class="w-100">
                    <a href="#" class="btn btn-default mt-4 mb-2 pr-5 pl-5">Añadir más aplicaciones </a>
                </li>
            </ul>
        </div>
    </div>
