<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucButtonMenuFlotante.ascx.cs" Inherits="WebForms.ucButtonMenuFlotante" %>
...
<nav class="shortcut-menu d-none d-sm-block">
    ...
    <a href="#" class="menu-item btn" data-toggle="tooltip" data-placement="left"
        title="Scroll Top">
        <i class="fal fa-arrow-up"></i>
    </a>
    <a href="page_login.html" class="menu-item btn" data-toggle="tooltip" data-placement="left"
        title="Logout">
